...
class HomepageSliderBlockController extends BlockController {
/*    ^^^^^^^^^^^^^^^
      CHANGE THIS PORTION
...
*/
	...
	protected $btTable = 'btHomepageSlider'; //Must be the same as table name in db.xml.
	                                          //Should correspond to block's directory/class name.
	
	public function getBlockTypeName() {
		return t('Homepage Slider'); //Appears in "Add Block" list when adding blocks to a page
	}
	
	public function getBlockTypeDescription() {
		return t('Homepage Slider'); //Only appears in dashboard "Add Functionality" page
	}
