...
class FamilyMemBlockController extends BlockController {
	
	protected $btName = 'Family Member';
	protected $btDescription = 'A block to add family members to the Meet Joe section.';
	protected $btTable = 'btDCFamilyMem';
